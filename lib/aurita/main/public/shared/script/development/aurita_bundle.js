...
Aurita.get_remote_string = function(action, response_fun, method, postVars) { 
  ...
  xml_conn.get_string('/aurita/'+action+'&mode=none', response_fun, method, postVars);
}; 
...
Aurita.load_widget = function(widget_name, params, handle_fun) { 
  try { 
    ...
    Aurita.get_remote_string('Widget_Service/get/widget='+widget_name+params_string, handle_fun); 
  } catch(excep) { 
